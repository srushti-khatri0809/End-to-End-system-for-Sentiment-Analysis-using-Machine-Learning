...
def create_app(twitter_keys, newsapi_keys, eventregistry_keys, name=None):
    ...
    app = flask.Flask(name, instance_relative_config=True, 
                      template_folder='C:/Users/Srushti/Desktop/App_WebNewsEngine-master/app/client/templates',
                      static_folder='C:/Users/Srushti/Desktop/App_WebNewsEngine-master/app/client/static')
    ...
    def text():
        return flask.render_template("frontend/text-analysis.html")
        ...
        try:
            ...
            if flask.request.method == 'POST':
                ...
                if query != "":
                    ...
                    model = search( dtf_news)
                    news, topic_sentim, img = model.data()
                    app.logger.info(str(topic_sentim))
                    #dtf_events = eventregistry.get_events(query) 
                    return flask.render_template("search.html", news=news, 
